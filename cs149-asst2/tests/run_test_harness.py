...
LIST_OF_TESTS = [
    ...
    ("strict_graph_deps_med_async", UNSPECIFIED_NUM_THREADS),
    ("strict_diamond_deps_async", UNSPECIFIED_NUM_THREADS),
    ("strict_graph_deps_small_async", UNSPECIFIED_NUM_THREADS),
    ("strict_graph_deps_large_async", UNSPECIFIED_NUM_THREADS)
]
...
if __name__ == '__main__':
    ...
    for (test_name, num_threads) in test_names_and_num_threads:
        ...
        if platform.system() == 'Darwin':
            ref_cmd = "../part_b/%s_osx -n %d" % (REFERENCE_BINARY_NAME, num_threads);
        else:
            ref_cmd = "../part_b/%s_linux -n %d" % (REFERENCE_BINARY_NAME, num_threads);
        student_cmd = "../part_b/%s -n %d" % (STUDENT_BINARY_NAME, num_threads);
